...
const AddClass = () => {
     ...
     const img_url = `https://api.imgbb.com/1/upload?key=${Image_Hosting_Token}`;
          ...
          fetch(img_url, {
               ...
               .then(imgResponse => {
                    if (imgResponse.success) {
                         ...
                         const addclass = { name, price: parseFloat(price), availableSeats: parseFloat(seats), classname, email, image: imgURL, status: 'pending' }
